...
(function () {
  ...
  reactHotLoader.register(__signature__, '__signature__', 'build/utils/caver.js');
  reactHotLoader.register(config, 'config', 'build/utils/caver.js');
  reactHotLoader.register(cav, 'cav', 'build/utils/caver.js');
  reactHotLoader.register(senderAddress, 'senderAddress', 'build/utils/caver.js');
})();
